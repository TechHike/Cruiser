	...
	<xsl:template match="/">
		...
		<html>
			...
			<body>
				...
				<xsl:variable name="history_updated" select="/t:Objs/t:Obj/t:DCT/t:En/t:S[@N='Key' and text()='updated_str']/following-sibling::t:S[@N='Value']" />
						...
						<div id="poll">
							<table>
								<tr>
									...
									<td>
										<xsl:value-of select="$history_updated" />
									</td>
								</tr>
								<tr>
									<td>Last Poll:</td>
